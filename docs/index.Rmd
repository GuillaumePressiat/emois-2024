...
#### > pouvoir reproduire les chiffres e-PMSI
  ...
  - faire vivre la notion de République numérique (ouvrir les savoirs numériques)
  - rassembler des acteurs de l'hôpital autour de la donnée PMSI (soignants, facturation, pharmacie, etc.)
