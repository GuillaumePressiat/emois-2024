...
####  Dans le répertoire `emois-2024-atelier/data`

#### Placer le fichier `290000017.2023.12.****out.zip`

#### ou les données de votre établissement
...
<img style="float: left" src="assets/Gaston_Lagaffe.png" height="400px">
